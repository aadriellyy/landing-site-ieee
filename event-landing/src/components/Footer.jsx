      ...
      <div className="footer-container">
        ...
        <div className="footer-info">
          ...
          <div className="footer-links">
            ...
            <a href="https://www.instagram.com/meninas.comp/" target="_blank">📸 Instagram</a>
            <a href="https://www.linkedin.com/company/meninas-comp/posts/?feedView=all" target="_blank">💼 LinkedIn</a>
          </div>
        </div>
